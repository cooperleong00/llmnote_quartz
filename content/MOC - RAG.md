...
- [[MOC - Foundations]] — Embedding、信息检索和 Transformer 基础
- [[MOC - Inference]] — context compression、serving 与长上下文成本
- [[MOC - Post-training]] — agentic workflow、tool use 和 post-training 数据
- [[MOC - Reinforcement Learning]] — Agentic RL 与交互式环境训练
