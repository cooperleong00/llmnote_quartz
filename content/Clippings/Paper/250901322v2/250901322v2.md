...
description: 560B MoE 模型，通过零计算专家动态分配计算预算（18.6B-31.3B/token）和快捷连接 MoE 实现高效训练与推理
aliases:
  - LongCat-Flash
tags:
  - architecture
...
| 6.1 |       |                                                 | 23                                                                                                                                                                         |
|-----|-------|-------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     | 6.1.1 | Computation and Communication Orchestration<br> | 24                                                                                                                                                                         |
|     | 6.1.2 | Speculative Decoding<br>                        | 24                                                                                                                                                                         |
|     | 6.1.3 | Reducing KV Cache<br>                           | 24                                                                                                                                                                         |
| 6.2 |       |                                                 | 25                                                                                                                                                                         |
|     | 6.2.1 | Minimize Schedule Overhead<br>                  | 25                                                                                                                                                                         |
...
|     |       |                                                 | 35                                                                                                                                                                         |
| A.1 |       |                                                 | 35                                                                                                                                                                         |
|     |       | Conclusion<br>Appendix                          | Model-Specific Inference Optimization<br>System-Wide Inference Techniques<br>Deployment and Performance<br>Contributions<br>Statistics and Case Studies of Dynamic Routing |
...
| $\sigma_{	ext{target}}^2 = \sigma_{	ext{proxy}}^2 \ \eta_{	ext{target}} = \eta_{	ext{proxy}}$                 |
|---------------------------------------------------------------------------------------------------------------|
| $\sigma_{\mathrm{target}}^2 = \sigma_{\mathrm{proxy}}^2/s \ \eta_{\mathrm{target}} = \eta_{\mathrm{proxy}}/s$ |
|                                                                                                               |
...
$$\mathcal{L}_{Z} = \frac{\lambda}{T} \sum_{t=1}^{T} (\log \sum_{i=1}^{|z_{t}|} \exp(abs(z_{t}^{i})))^{2},$$
(10)
...
| SuperGPQA (acc)     | -                     | 40.58*                   | 44.70*          | 54.19                 |  |  |  |
...
|---------------------------------------|------------------|-------------------|---------------|---------|-------------------|--------------------|---------------|
| Architecture                          | MoE              | MoE               | MoE           | _       | _                 | -                  | MoE           |
...
| $	au^2$ -Bench (telecom) $_{(avg@4)}$ | 38.50            | 22.50             | 67.50         | 35.20   | 46.20             | 16.50              | 73.68         |
