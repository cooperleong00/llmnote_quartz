...
[[Positional Encoding]] 解决 Attention 的顺序感知问题。具体位置编码方案在 [[MOC - Attention]] 中展开，基础入口包括 [[RoPE]] 和 [[ALiBi]]。
...
更系统的训练效率问题见 [[MOC - Distributed Training]]。
...
RL 基础服务于两类问题：经典序贯决策，以及 LLM post-training 中的策略优化。完整算法脉络见 [[MOC - Reinforcement Learning]]。
...
- [[MOC - Attention]] — Transformer 中 Attention 与位置编码的深入导航
- [[MOC - Reinforcement Learning]] — RL 算法从基础到 LLM alignment 的完整路径
- [[MOC - Distributed Training]] — 训练效率、显存和并行策略
- [[MOC - Post-training]] — SFT、RLHF、DPO、Online RL 与 Agentic RL
