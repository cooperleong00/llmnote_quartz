...
Agentic RL 与 [[MOC - RAG]] 的连接点是 retrieval/tool use 成为环境动作；与 [[MOC - Distributed Training]] 的连接点是 rollout 系统和异步训练框架。
...
- [[MOC - Reinforcement Learning]] — 从经典 RL 到 LLM RL 的算法主线
- [[MOC - Foundations]] — KL、Bradley-Terry、Policy Gradient、PPO 的前置概念
- [[MOC - Distributed Training]] — RL 训练系统、rollout 编排与显存效率
- [[MOC - RAG]] — Agentic RAG 与工具/检索环境
