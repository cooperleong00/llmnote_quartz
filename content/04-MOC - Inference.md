...
[[Mixture of Experts]] 也属于架构层效率设计。它让每个 token 只激活部分 expert，降低每 token 计算量；对应的训练和并行问题见 [[03-MOC - Distributed Training|MOC - Distributed Training]]。
...
- [[02-MOC - Attention|MOC - Attention]] — Attention 架构、KV Cache 与高效注意力
- [[03-MOC - Distributed Training|MOC - Distributed Training]] — 显存计算、并行策略与训练系统
- [[05-MOC - RAG|MOC - RAG]] — 检索上下文压缩与知识增强生成
- [[07-MOC - Post-training|MOC - Post-training]] — reasoning model 带来的推理 token 与 serving 压力
